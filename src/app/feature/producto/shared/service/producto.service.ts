...
export class ProductoService {
  ...
  public consultarPorId(idProducto:number){
    return this.http.doGet<Producto>(`${environment.endpoint}/productos/${idProducto}`,
                                                  this.http.optsName('consultar producto por id'));
  }
}
